...
Symmetric algorithms are those that use the same key to encrypt and to decrypt the data.
...
- Advanced Encryption Standard (AES): In 2002, it was chosen as the replacement for DES. It can be deployed in key sizes of 128. 192 or 256 bits.
