...
This is going to be a series of posts on my journey to build an 8-bit computer. 

The reason why I decided to build an 8-bit computer from scratch is because I thought it would be a great project to refresh up my electronics skills and learn some new ones.
